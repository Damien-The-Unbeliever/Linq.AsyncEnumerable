...
namespace DamienTheUnbeliever.System.Linq.Tests
{
  ...
  public class FirstOrDefault
  {
    ...
    public void Eagerly_Validates_Source()
    {
      ...
      {
        var iter = AsyncEnumerable.FirstOrDefault((IAsyncEnumerable<int>)null);
      });
    }
    [Fact]
    public void Eagerly_Validates_Source_Plain_Predicate()
    {
      Assert.Throws<ArgumentNullException>(() =>
      {
        var iter = AsyncEnumerable.FirstOrDefault(null, QuickFunctions<bool>.Identity);
      });
    }
    [Fact]
    public void Eagerly_Validates_Source_Task_Predicate()
    {
      Assert.Throws<ArgumentNullException>(() =>
      {
        var iter = AsyncEnumerable.FirstOrDefault(null, QuickFunctions<bool>.IdentityTasked);
      });
    }
    [Fact]
    public void Eagerly_Validates_Source_ValueTask_Predicate()
    {
      Assert.Throws<ArgumentNullException>(() =>
      {
        var iter = AsyncEnumerable.FirstOrDefault(null, QuickFunctions<bool>.IdentityWrapped);
      });
    }
    [Fact]
    public void Eagerly_Validates_Plain_Predicate()
    {
      Assert.Throws<ArgumentNullException>(() =>
      {
        var iter = AsyncEnumerable.FirstOrDefault(AsyncEnumerable.Empty<bool>(), (Func<bool,bool>)null);
      });
    }
    [Fact]
    public void Eagerly_Validates_Task_Predicate()
    {
      Assert.Throws<ArgumentNullException>(() =>
      {
        var iter = AsyncEnumerable.FirstOrDefault(AsyncEnumerable.Empty<bool>(), (Func<bool, Task<bool>>)null);
      });
    }
    [Fact]
    public void Eagerly_Validates_ValueTask_Predicate()
    {
      Assert.Throws<ArgumentNullException>(() =>
      {
        var iter = AsyncEnumerable.FirstOrDefault(AsyncEnumerable.Empty<bool>(), (Func<bool, ValueTask<bool>>)null);
      });
    }
    ...
    public async Task Awaiting_Result_Iterates_Source_Plain_Predicate()
    {
      ...
      await Assert.ThrowsAsync<NotImplementedException>(async () =>
      {
        await target.FirstOrDefault(QuickFunctions<bool>.Identity);
      });
    }
    [Fact]
    public async Task Awaiting_Result_Iterates_Source_Task_Predicate()
    {
      ...
      await Assert.ThrowsAsync<NotImplementedException>(async () =>
      {
        await target.FirstOrDefault(QuickFunctions<bool>.IdentityTasked);
      });
    }
    [Fact]
    public async Task Awaiting_Result_Iterates_Source_ValueTask_Predicate()
    {
      ...
      await Assert.ThrowsAsync<NotImplementedException>(async () =>
      {
        await target.FirstOrDefault(QuickFunctions<bool>.IdentityWrapped);
      });
    }
    ...
    public async Task Empty_Sequence_Returns_Default()
    {
      ...
      var actual = await target.FirstOrDefault();
    ...
    public async Task Empty_Sequence_Returns_Default_Task_Predicate()
    {
      ...
      var actual = await target.FirstOrDefault(a => Task.FromResult(true));
    ...
    public async Task Multi_Sequence_Returns_ValueTask_Predicate()
    {
      ...
      var actual = await target.FirstOrDefault(a=>a%2==1);
    ...
    public async Task Multi_Sequence_Returns_Task_Predicate()
    {
      ...
      var actual = await target.FirstOrDefault(a => Task.FromResult(a % 2 == 1));
