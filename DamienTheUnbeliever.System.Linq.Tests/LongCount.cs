...
namespace DamienTheUnbeliever.System.Linq.Tests
{
  ...
  public class LongCount
  {
    ...
    public void Eagerly_Validates_Source_No_Predicate()
    {
      ...
      {
        var iter = AsyncEnumerable.LongCount((IAsyncEnumerable<bool>)null);
      });
    }
    [Fact]
    public void Eagerly_Validates_Source_Plain_Predicate()
    {
      Assert.Throws<ArgumentNullException>(() =>
      {
        var iter = AsyncEnumerable.LongCount(null,QuickFunctions<bool>.Identity);
      });
    }
    [Fact]
    public void Eagerly_Validates_Source_Task_Predicate()
    {
      Assert.Throws<ArgumentNullException>(() =>
      {
        var iter = AsyncEnumerable.LongCount(null, QuickFunctions<bool>.IdentityTasked);
      });
    }
    [Fact]
    public void Eagerly_Validates_Source_ValueTask_Predicate()
    {
      Assert.Throws<ArgumentNullException>(() =>
      {
        var iter = AsyncEnumerable.LongCount(null, QuickFunctions<bool>.IdentityWrapped);
      });
    }
    [Fact]
    public void Eagerly_Validates_Plain_Predicate()
    {
      ...
      Assert.Throws<ArgumentNullException>(() =>
      {
        var iter = AsyncEnumerable.LongCount(target, (Func<bool,bool>)null);
      });
    }
    [Fact]
    public void Eagerly_Validates_Task_Predicate()
    {
      ...
      Assert.Throws<ArgumentNullException>(() =>
      {
        var iter = AsyncEnumerable.LongCount(target, (Func<bool,Task<bool>>)null);
      });
    }
    [Fact]
    public void Eagerly_Validates_ValueTask_Predicate()
    {
      ...
      Assert.Throws<ArgumentNullException>(() =>
      {
        var iter = AsyncEnumerable.LongCount(target, (Func<bool, ValueTask<bool>>)null);
      });
    }
    [Fact]
    ...
    public async Task Awaiting_Result_Starts_Iteration_Task_Predicate()
    {
      ...
      await Assert.ThrowsAsync<NotImplementedException>(async () =>
      {
        await target.LongCount(QuickFunctions<bool>.IdentityTasked);
      });
    }
    [Fact]
    public async Task Awaiting_Result_Starts_Iteration_ValueTask_Predicate()
    {
      ...
      await Assert.ThrowsAsync<NotImplementedException>(async () =>
      {
        await target.LongCount(QuickFunctions<bool>.IdentityWrapped);
      });
    }
    ...
    public async Task Empty_Sequence_Is_Zero()
    {
      ...
      var actual = await target.LongCount();
    ...
    public async Task Empty_Sequence_Is_Zero_Tasked()
    {
      ...
      var actual = await target.LongCount(l=>Task.FromResult(true));
    ...
    public async Task Non_Empty_Sequence_Is_Non_Zero_Tasked()
    {
      ...
      var actual = await target.LongCount(l => Task.FromResult(l<8));
