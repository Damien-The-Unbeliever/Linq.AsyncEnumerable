  ...
  namespace Generic
  {
    ...
    public class Max
    {
      ...
      public void Eagerly_Validates_Source()
      {
        ...
        {
          var iter = AsyncEnumerable.Max<int>(null);
        });
      }
      [Fact]
      public void Eagerly_Validates_Source_Plain_Selector()
      {
        Assert.Throws<ArgumentNullException>(() =>
        {
          var iter = AsyncEnumerable.Max<int,long>(null, a => (long)a);
        });
      }
      [Fact]
      public void Eagerly_Validates_Source_Task_Selector()
      {
        Assert.Throws<ArgumentNullException>(() =>
        {
          var iter = AsyncEnumerable.Max<int,long>(null, a => Task.FromResult((long)a));
        });
      }
      [Fact]
      public void Eagerly_Validates_Source_ValueTask_Selector()
      {
        Assert.Throws<ArgumentNullException>(() =>
        {
          var iter = AsyncEnumerable.Max<int,long>(null, a => new ValueTask<long>((long)a));
        });
      }
      [Fact]
      public void Eagerly_Validates_Source_Comparer()
      {
        Assert.Throws<ArgumentNullException>(() =>
        {
          var iter = AsyncEnumerable.Max<int>(null,new IntComparer());
        });
      }
      [Fact]
      public void Eagerly_Validates_Source_Plain_Selector_Comparer()
      {
        Assert.Throws<ArgumentNullException>(() =>
        {
          var iter = AsyncEnumerable.Max<int, long>(null, a => ((long)a), new LongComparer());
        });
      }
      [Fact]
      public void Eagerly_Validates_Source_Task_Selector_Comparer()
      {
        Assert.Throws<ArgumentNullException>(() =>
        {
          var iter = AsyncEnumerable.Max<int, long>(null, a => Task.FromResult((long)a), new LongComparer());
        });
      }
      [Fact]
      public void Eagerly_Validates_Source_ValueTask_Selector_Comparer()
      {
        Assert.Throws<ArgumentNullException>(() =>
        {
          var iter = AsyncEnumerable.Max<int, long>(null, a => new ValueTask<long>((long)a), new LongComparer());
        });
      }
      [Fact]
      public void Eagerly_Validates_Plain_Selector()
      {
        Assert.Throws<ArgumentNullException>(() =>
        {
          var iter = AsyncEnumerable.Max<int, long>(AsyncEnumerable.Empty<int>(), (Func<int,long>)null);
        });
      }
      [Fact]
      public void Eagerly_Validates_Task_Selector()
      {
        Assert.Throws<ArgumentNullException>(() =>
        {
          var iter = AsyncEnumerable.Max<int, long>(AsyncEnumerable.Empty<int>(), (Func<int, Task<long>>)null);
        });
      }
      [Fact]
      public void Eagerly_Validates_ValueTask_Selector()
      {
        Assert.Throws<ArgumentNullException>(() =>
        {
          var iter = AsyncEnumerable.Max<int, long>(AsyncEnumerable.Empty<int>(), (Func<int, ValueTask<long>>)null);
        });
      }
      [Fact]
      public void Eagerly_Validates_Plain_Selector_Comparer()
      {
        Assert.Throws<ArgumentNullException>(() =>
        {
          var iter = AsyncEnumerable.Max<int, long>(AsyncEnumerable.Empty<int>(), (Func<int, long>)null, new LongComparer());
        });
      }
      [Fact]
      public void Eagerly_Validates_Task_Selector_Comparer()
      {
        Assert.Throws<ArgumentNullException>(() =>
        {
          var iter = AsyncEnumerable.Max<int, long>(AsyncEnumerable.Empty<int>(), (Func<int, Task<long>>)null, new LongComparer());
        });
      }
      [Fact]
      public void Eagerly_Validates_ValueTask_Selector_Comparer()
      {
        Assert.Throws<ArgumentNullException>(() =>
        {
          var iter = AsyncEnumerable.Max<int, long>(AsyncEnumerable.Empty<int>(), (Func<int, ValueTask<long>>)null, new LongComparer());
        });
      }
      [Fact]
      public async Task Awaiting_Result_Starts_Iterating()
      {
        ...
        {
          await AsyncEnumerable.Max<int>(target);
        });
      }
      [Fact]
      public async Task Awaiting_Result_Starts_Iterating_Plain_Selector()
      {
        ...
        await Assert.ThrowsAsync<NotImplementedException>(async () =>
        {
          await AsyncEnumerable.Max<int,int>(target,QuickFunctions<int>.Identity);
        });
      }
      [Fact]
      public async Task Awaiting_Result_Starts_Iterating_Task_Selector()
      {
        ...
        await Assert.ThrowsAsync<NotImplementedException>(async () =>
        {
          await AsyncEnumerable.Max<int, int>(target, QuickFunctions<int>.IdentityTasked);
        });
      }
      [Fact]
      public async Task Awaiting_Result_Starts_Iterating_ValueTask_Selector()
      {
        ...
        await Assert.ThrowsAsync<NotImplementedException>(async () =>
        {
          await AsyncEnumerable.Max<int, int>(target, QuickFunctions<int>.IdentityWrapped);
        });
      }
      [Fact]
      public async Task Awaiting_Result_Starts_Iterating_Comparer()
      {
        ...
        await Assert.ThrowsAsync<NotImplementedException>(async () =>
        {
          await AsyncEnumerable.Max<int>(target,new IntComparer());
        });
      }
      [Fact]
      public async Task Awaiting_Result_Starts_Iterating_Plain_Selector_Comparer()
      {
        ...
        await Assert.ThrowsAsync<NotImplementedException>(async () =>
        {
          await AsyncEnumerable.Max<int, int>(target, QuickFunctions<int>.Identity, new IntComparer());
        });
      }
      [Fact]
      public async Task Awaiting_Result_Starts_Iterating_Task_Selector_Comparer()
      {
        ...
        await Assert.ThrowsAsync<NotImplementedException>(async () =>
        {
          await AsyncEnumerable.Max<int, int>(target, QuickFunctions<int>.IdentityTasked, new IntComparer());
        });
      }
      [Fact]
      public async Task Awaiting_Result_Starts_Iterating_ValueTask_Selector_Comparer()
      {
        ...
        await Assert.ThrowsAsync<NotImplementedException>(async () =>
        {
          await AsyncEnumerable.Max<int, int>(target, QuickFunctions<int>.IdentityWrapped, new IntComparer());
        });
      }
      [Fact]
      ...
      public async Task Empty_Nullable_Returns_Default_Value_Selector()
      {
        ...
        var actual = await AsyncEnumerable.Max<int?>(target);
      ...
      public async Task Empty_Reference_Returns_Default_Value_Selector()
      {
        ...
        var actual = await AsyncEnumerable.Max<string>(target);
      ...
      public async Task Empty_ValueType_Throws_Task_Selector()
      {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(async () =>
        {
          await AsyncEnumerable.Max<int,int>(target,a=>Task.FromResult(a));
        });
      }
      [Fact]
      public async Task Empty_Nullable_Returns_Default_Task_Selector()
      {
        ...
        var actual = await AsyncEnumerable.Max<int?,int?>(target,a => Task.FromResult(a));
      ...
      public async Task Empty_Reference_Returns_Default_Task_Selector()
      {
        ...
        var actual = await AsyncEnumerable.Max<string,string>(target, a => Task.FromResult(a));
