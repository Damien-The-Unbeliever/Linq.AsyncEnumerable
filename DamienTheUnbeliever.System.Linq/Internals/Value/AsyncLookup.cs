...
namespace DamienTheUnbeliever.System.Linq.Internals.Value
{
  internal class AsyncLookup<TSource, TKey, TElement> : IAsyncLookup<TKey, TElement>
  {
    ...
    private Func<TSource, ValueTask<TKey>>? _keySelector;
    private Func<TSource, ValueTask<TElement>>? _elementSelector;
